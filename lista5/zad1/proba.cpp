...
void runTests()
{
    ...
    for (int n : sizes)
    {
        std::string str1("AKFSKDDHKFSHKDJFSKDFHKSABBBBBBBBBA");
        std::string str2("ABABBBBBBBBBASFDFJHSKDJFH");
        ...
        outputFile << n << " " << duration << " " << longestSubsequence << " " << longestSubsequence.length() << std::endl;
    }
